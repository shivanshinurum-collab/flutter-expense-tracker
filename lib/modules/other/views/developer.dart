...
class DeveloperPage extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              _buildInfoCard(
                ...
                'Email',
                's.kushwah9898@gmail.com',
                onTap: () => launchUrl(Uri.parse('mailto:s.kushwah9898@gmail.com')),
              ),
              ...
              _buildInfoCard(
                ...
                'Phone',
                '+91 98268 71510',
                onTap: () => launchUrl(Uri.parse('tel:+919826871510')),
              ),
              const SizedBox(height: 16),
              _buildInfoCard(
                context,
                ...
                onTap: () => launchUrl(Uri.parse('https://www.google.com/maps/search/?api=1&query=Indore')),
              ),
              const SizedBox(height: 32),
  ...
  Widget _buildInfoCard(BuildContext context, IconData icon, String title, String value, {VoidCallback? onTap}) {
    final theme = Theme.of(context);
    return InkWell(
      onTap: onTap,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (onTap != null)
              Icon(Icons.arrow_forward_ios, size: 14, color: theme.colorScheme.primary.withOpacity(0.5)),
          ],
        ),
      ),
    );
